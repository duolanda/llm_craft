...
新增护甲类型与伤害类型交互机制。所有单位和建筑都有护甲类型，部分单位有伤害类型：
...
**单位属性表:**
| 单位 | HP | 攻击 | 射程 | 护甲 | 伤害类型 | 造价 |
|------|-----|------|------|------|---------|------|
| Worker | 50 | 0 | 0 | 轻甲 | - | 50 |
| Soldier | 80 | 12 | 1 | 轻甲 | 穿刺 | 80 |
| Tank | 200 | 20 | 1 | 重甲 | 无 | 150 |
| Demolisher | 40 | 25 | 3 | 轻甲 | 爆炸 | 120 |

**克制关系:** Tank(重甲)克制 Soldier(穿刺减半) → Soldier(轻甲)克制 Demolisher(轻甲) → Demolisher(爆炸)克制 Tank(爆炸对重甲150%)。Barracks 可生产 soldier/tank/demolisher。
